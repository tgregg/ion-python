...
_SKIP_LIST = (
    ...
    _good_file(u'subfieldVarUInt.ion'),
    _good_file(u'subfieldVarUInt32bit.ion'),
    ...
    _equivs_file(u'structsFieldsRepeatedNames.ion'),
    _nonequivs_file(u'structs.ion'),

    # BINARY:
    _good_file(u'structAnnotatedOrdered.10n'),  # TODO investigate.
    _good_file(u'structOrdered.10n'),  # TODO investigate.
    # TODO the following contain inaccurate annot_length subfields, which pass in weird ways. Needs to be fixed.
    _bad_file(u'container_length_mismatch.10n'),
    _bad_file(u'emptyAnnotatedInt.10n'),
)
